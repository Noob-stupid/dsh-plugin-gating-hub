...
- **What it is**: the monolithic `lib/index.js` (7637 lines) split into layers — `lib/index.js` **142 lines** + `lib/server/**` **36 modules**; **feature-equivalent to `0.3.49`**, maintainability only;
...
- **For everyday use** stick to npm `@noob-stupid/dsh-plugin-console@0.3.49`, or `main` of this repo.
