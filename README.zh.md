...
- **它是什么**：把单体 `lib/index.js`（7637 行）拆成分层结构 —— `lib/index.js` **142 行** + `lib/server/**` **36 个模块**，**功能与 `0.3.49` 等价**，只为可维护性；
...
- **日常使用请继续用**：npm `@noob-stupid/dsh-plugin-console@0.3.49`，或本仓库 `main`。
- 请多反馈问题
