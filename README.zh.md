...
- **它是什么**：把单体 `lib/index.js`（8547 行）拆成分层结构 —— `lib/index.js` **141 行** + `lib/server/**` **38 个模块**，**功能与 `0.3.55` 等价**，只为可维护性；
...
- **日常使用请继续用**：npm `@noob-stupid/dsh-plugin-console@0.3.55`，或本仓库 `main`。
- 请多反馈问题
